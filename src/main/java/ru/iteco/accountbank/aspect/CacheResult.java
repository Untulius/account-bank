...
public class CacheResult {
    ...
    @Around("methodsWithCacheResultAnnotation()")
    public Object aroundMethodsWithCacheResultAnnotation(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
    ...
    public void methodsWithCacheResultAnnotation() {}
